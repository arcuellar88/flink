...
public class SlidingEventTimeWindowsOutOfOrder extends WindowAssignerOutOfOrder<Object, TimeWindow> {
	...
	protected SlidingEventTimeWindowsOutOfOrder(long size, long slide) {
		this.size = size;
		this.slide = slide;
	 ...
	 */
	public static SlidingEventTimeWindowsOutOfOrder of(Time size, Time slide) {
		return new SlidingEventTimeWindowsOutOfOrder(size.toMilliseconds(), slide.toMilliseconds());
	}
