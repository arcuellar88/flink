 ...
 */
@PublicEvolving
public abstract class WindowAssignerOutOfOrder<T, W extends TimeWindow> extends WindowAssigner<T, TimeWindow> {
	 ...
	 */
	public abstract Collection<W> assignWindowsOutOfOrder(T element, long timestamp,long lastStart);
